...
import { LayoutGrid, Compass, Pin, Sun, Moon, ShieldAlert, Star } from "lucide-react";
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-xs overflow-hidden rounded-2xl border-border/20 bg-background/95 p-0 shadow-2xl backdrop-blur-xl">
            <div className="border-b border-border/10 bg-muted/30 px-5 py-4">
              <DialogTitle className="text-xs font-bold uppercase tracking-widest text-foreground">Anchored Nodes</DialogTitle>
            </div>
